...
class PackageConditionMapper extends AbstractMapper
{
    ...
    public function read($data, IReader $reader, IMappingContext $context = null)
    {
        ...
        switch ($type) {
            ...
            case 'coupons':
                ...
                $condition = new CouponCondition($data['value'] ?? [], $operator);
                break;
    ...
    private static function createEnumCondition($operator, $value)
    {
    ...
    private static function getNumberCondition($operator, $compareWith, NumberUnit $unit)
    {
    ...
    private static function getEnumConditionClass($operator)
    {
        $conditions = array(
